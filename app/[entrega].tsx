import { patchDevolucao } from '@/api';
		...
		Alert.alert(
			...
			[
				...
				},
				{
					text: "Sim",
					onPress: () => {
						patchDevolucao(entrega as string, employeeSignature, keeperSignature)
	...
	return (
		<SafeAreaView className='lajota'>
			<View className='cabecalho'>
				...
				<Text className="texto-titulo">Devolução da Entrega {entrega}</Text>
			</View>
